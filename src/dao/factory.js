...
switch (config.persistence) {
    ...
    case 'MONGO':
        ...
        const { default: MessageMongo } = await import('./mongo/messages_mongo.js')
        const { default: UserMongo } = await import('./mongo/users_mongo.js')
        const { default: CartMongo } = await import('./mongo/carts_mongo.js')
