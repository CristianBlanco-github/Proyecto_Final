...
import cartsRouter from './routers/cart_router.js';
import chatRouter from './routers/chat_router.js';
import sessionRouter from './routers/session_router.js';
import viewsRouter from './routers/products_views_router.js';
...
mongoose.connect(config.mongoURI,{dbName: config.mongoDBName}, async (error)=>{
    if (!error){
